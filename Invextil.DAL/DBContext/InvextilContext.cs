...
namespace Invextil.DAL.DBContext;

public partial class InvextilContext : DbContext
{
    public InvextilContext()
    {
    }

    public InvextilContext(DbContextOptions<InvextilContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCita).HasName("PK__Cita__814F31268A2AFA53");
            ...
            entity.HasOne(d => d.IdEmpleadoNavigation).WithMany(p => p.Cita)
                ...
                .HasConstraintName("FK__Cita__idEmpleado__5CD6CB2B");
        });
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F44242217");
            ...
            entity.HasOne(d => d.IdProductoNavigation).WithMany(p => p.DetalleVenta)
                ...
                .HasConstraintName("FK_DetalleVenta_Tela");
        ...
        {
            entity.HasKey(e => e.IdEmpleado).HasName("PK__Empleado__5295297CC9064C53");
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Familia__8A3D240C740E01B5");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF4838D86A7F9");
        ...
        {
            entity.HasKey(e => e.IdMuestra).HasName("PK__Muestra__2B64DBFBFB1A9725");
            ...
            entity.HasOne(d => d.IdTelaNavigation).WithMany(p => p.Muestras)
                .HasForeignKey(d => d.IdTela)
                .HasConstraintName("FK__Muestra__idTela__02FC7413");
        });

        modelBuilder.Entity<NumeroCorrelativo>(entity =>
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E660EB3B7");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76AB22B45D");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D8A4C72DA6");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Tela__07F4A1323C71D992");
            ...
            entity.HasOne(d => d.IdCategoriaNavigation).WithMany(p => p.Telas)
                .HasForeignKey(d => d.IdCategoria)
                .HasConstraintName("FK__Tela__idCategori__36B12243");
        });

        modelBuilder.Entity<TipoDocumentoVenta>(entity =>
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEEC9884014");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614F9C4FDB4");
