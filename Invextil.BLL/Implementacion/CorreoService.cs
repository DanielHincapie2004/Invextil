...
namespace Invextil.BLL.Implementacion
{
    public class CorreoService : ICorreoService
    {
        ...
        //Metodo obtener los datos requeridos del ususario al cual se le debe enviar el correo
        //Ademas especifica que el correo debe recibir una estructura html en su body
        public async Task<bool> EnviarCorreo(string CorreoDestino, string Asunto, string Mensaje)
        {
            try
            {
                //Usar repositorio para adquirir las credenciales
